...
internal const val EXTRA_OPEN_REGISTRATION = "open_registration"
...
internal fun addScheduleIntent(context: Context): Intent =
    Intent(context, MainActivity::class.java).apply {
        flags = Intent.FLAG_ACTIVITY_NEW_TASK or Intent.FLAG_ACTIVITY_CLEAR_TOP
        putExtra(EXTRA_OPEN_REGISTRATION, true)
    }
