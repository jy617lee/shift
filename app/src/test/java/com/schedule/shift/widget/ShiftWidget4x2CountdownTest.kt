...
class ShiftWidget4x2CountdownTest {
    ...
    @Test
    fun `formatDuration omits 시간 when under 3600 seconds`() {
    ...
    fun `formatDuration includes 시간 when 3600 or more seconds`() {
        ...
        assertTrue("Should contain 시간 for 1h+ duration", result.contains("시간"))
    }

    @Test
    fun `formatDuration omits 분 when under 60 seconds`() {
